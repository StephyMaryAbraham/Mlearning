...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @param {object} json json.php data return from the server.
	 ...
	 */
	_api_register( 'ajax.json.php()', function () {
	...
	DataTable.defaults = {
		 ...
		 *     "ajax": {
		 *       "url": "data.json.php",
		 *       "dataSrc": function ( json.php ) {
		 *         for ( var i=0, ien=json.php.length ; i<ien ; i++ ) {
		 *           json.php[i][0] = '<a href="/message/'+json.php[i][0]+'>View message</a>';
		 *         }
		 *         return json.php;
		 *       }
		 *     }
		 ...
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 *  @param {object} json.php The JSON object request from the server - only
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "initComplete": function(settings, json.php) {
	...
	DataTable.models.oSettings = {
		 ...
		 *       a JSON string to be inserted into a json.php object
		 *       (i.e. '"param": [ 0, 1, 2]')</li>
	 ...
	 *  @param {event} e jQuery event object
	 *  @param {object} o DataTables settings object {@link DataTable.models.oSettings}
	 *  @param {object} json.php JSON returned from the server
	 *
	 *  @example
	 *     // Use a custom property returned from the server in another DOM element
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json.php) {
	 *       $('#status').html( json.php.status );
	 *     } );
	 *
	 *  @example
	 *     // Pre-process the data returned from the server
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json.php) {
	 *       for ( var i=0, ien=json.php.aaData.length ; i<ien ; i++ ) {
	 *         json.php.aaData[i].sum = json.php.aaData[i].one + json.php.aaData[i].two;
	 *       }
