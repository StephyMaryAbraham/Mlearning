...
<div id="page-wrapper" >
    <div id="page-inner" style="background-color:CadetBlue;">
        ...
        <div class="container">
            <form class="form-horizontal" method="post" action="viewques_tstname_action.php">
            ...
            <option value="EC">EC</option>
              ...
              <option value="MBA">MBA</option>
                    ...
                    <div class="col-sm-1">
                        ...
                        <a href="view_questions.php" class="btn btn-md btn-success" >View All</a>
        ...
        <table class="table table-condensed">
            ...
            $sql="select * from tb_questions join tb_test on tb_questions.testid=tb_test.testid where tb_test.department='$dept' and tb_test.testid='$testid'";
           //echo $sql;
